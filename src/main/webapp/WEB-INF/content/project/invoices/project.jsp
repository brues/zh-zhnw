...
<head>
    ...
    <script>
        function goxiangmurenyuan(id){
            $("#hiddenFormId").val(id);
            $("#hiddenForm").attr("action","${pageContext.request.contextPath}/project/invoice");
            $("#hiddenForm").submit();
        }
    </script>
    <%-- 跳转到发票 end --%>
...
<div class="container" style="width: 100%;max-width:95%;height: 100%;padding-top: 30px;">
    <div class="container-fluid" >
        <div class="row-fluid">
            <div class="span12">
                <form id="pageAction" action="${pageContext.request.contextPath}/project/invoice/project" method="post" style="font-size: 10pt;">
                    <div>
                    ...
                    <table class="table">
                        ...
                        <c:forEach var="project" items="${projectList}">
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-xs btn-success" onclick="goxiangmurenyuan(${project.id})" >查看发票</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
