...
<div class="container" style="width: 100%;max-width:95%;height: 100%;padding-top: 30px;">
    <div class="container-fluid" >
        <div class="row-fluid">
            <div class="span12">
                <form id="pageAction" action="${pageContext.request.contextPath}/project/invoice" method="post" style="font-size: 10pt;" class="form-horizontal"  role="form">
                    <div>
                        ...
                        <fieldset>
                            ...
                            <table style="width: 100%;height: 300px;">
                                ...
                                <tr>
                                    ...
                                    <td><div class="col-sm-10">
                                        <select id="input6" class="form-control input-lg" name="isCharge" data-live-search="true">
                                ...
                                <tr>
                                    ...
                                    <td><div class="col-sm-10">
                                        <select id="input7" class="form-control input-lg" name="type" data-live-search="true">
